...
## 📌 Описание
Цель проекта - оценить, как наличие редких классов ("long-tail") влияет на качество моделей машинного обучения, и сравнить эффективность различных подходов к извлечению признаков (MFCC, CQT, Wav2Vec2) и архитектур (MLP, CNN).
